        ...
        $(document).ready(function() {
            ...
            $("#uid").blur(function() {
                ...
                $.get(actionUrl, function(response) {
                    // alert(response);
                    if (response == "<font color='red'> &nbsp;&nbsp;&nbsp;User ID already registered </font>") {
                        jassusE = false;
            ...
            $("#btnsubmit").click(function() {
                if (jassusA == true && jassusB == true && jassusC == true && jassusD == true && jassusE == true) {
                    var querystring = $("#form").serialize();
                    var actionurl = "submit-ajax.php?" + querystring;
                    var actionurlmsg = "msg-signin.php?" + querystring;
                    ////////==SUBMISSION==///////////
                    $.get(actionurl, function(msg) {
                        $("#spnsubmit").html(msg).css("color", "green");
                    });
                    /////////////////==MESSAGING==/////////////
                    ...
                    $("#spnsubmit").html("Kindly follow the above instructions").css("color", "red");

            });
            /////////////////==AJAX-LOGIN==////////////
            $("#btnlogin").click(function() {
                var querystring = $("#formlogin").serialize();
                var url = "login-ajax.php?" + querystring;
                $.get(url, function(msglogin) {
                    if (msglogin == "citizen") {
                        location.href = "dash-citizen.php";
                        $("#spnlogin").html("Valid User ID..Logged in as" + msglogin).css("color", "green");
                    } else if (msglogin == "worker") {
                        location.href = "dash-worker.php";
                        $("#spnlogin").html("Valid User ID..Logged in as" + msglogin).css("color", "green");
                    } else
                        $("#spnlogin").html("Invalid User ID or Password").css("color", "red");
                });
            });
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="signin">
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" required id="uid" name="uid" placeholder="Enter your User ID plz...">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check ml-1">
                                    <input class="form-check-input" type="radio" name="category" required id="categoryw" value="ngo">
                                    <label class="form-check-label ml-1" for="categoryw">
                                        NGO's
                                    </label>
                                    <input class="form-check-input ml-4" type="radio" name="category" required id="categoryc" value="citizen">
                                    <label class="form-check-label ml-5" for="categoryc">
                                        CITIZEN
                                    </label>
                                </div>
                            </div>
                    ...
                    <div style="margin-left:30px"><span id="spnsubmit">&nbsp;</span></div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="login">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div style="margin-left:30px"><span id="spnlogin">&nbsp;</span></div>
